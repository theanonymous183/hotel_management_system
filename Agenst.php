...
<body>
 ...
 <div id="menu" style="background-color:pink;">
  ...
  <div id="menu1"><img src="f.jpg " height="270px" width="450px"/></div> 
<div id="write2">
<center><h1>HOTAL</h1></center>
</div>
 </div>
 </div>
 <div id="menu2">
 <ul> 
  ...
  <a li href="Biling.php">Biling </li></a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
   <a li href="Booking.php">Booking</li></a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
   <a li href="contactus.php">CONTACTUS</li></a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
    <a li href="patient.php">Lookup</li></a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
	 <a li href="login.php">Reportion</li></a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
	  
 </ul>
 </div>
   <div id="menu1"><img src="RCB.jpg " height="570px" width="1330px"/></div> 
<div id="vinod">
 <center><div id="left11"><h1>About </h1>
Our Vision
...
<h1>Our 3 guiding principles</h1>
 
<h3>1. Customers set the course</h3>
 
   The influence of market forces in healthcare is continually growing. This means that our customers are looking at our services more critically. They are challenging us to earn their business by offering better care, service and accessibility.<h3>2. It pays to invest in healthcare</h3>
...
<h3>Mobile No</h3>
9559213412,9936137239

 </div>
 </div>
 <div id="v1"><h1>Follow us on</h1>
